(function() {
  ...
  module.exports = {
    ...
    text: function(text, x, y, options) {
      var margins, match, matches, _i, _len, _ref, _ref1, _ref2;
      if (x == null) {
        x = {};
      }
      if (options == null) {
    ...
    _wrap: function(text, options) {
      var buffer, i, indent, lastLine, len, lineWidth, nextY, spaceLeft, w, width, word, wordWidths, words, wrap, _i, _len, _ref;
      wrap = this._wrapState;
    ...
    _nextSection: function(options) {
      ...
      if (++wrap.column > options.columns) {
        if (options.callbackPackage && options.callbackPackage.wrapToNewPage) {
