(function() {
  ...
  module.exports = {
    ...
    text: function(text, x, y, options) {
      var line, match, matches, paragraphs, _i, _j, _len, _len1;
      if (x == null) {
        x = {};
      }
      if (options == null) {
    ...
    _wrap: function(paragraphs, options) {
      var buffer, i, indent, len, lineWidth, nextY, spaceLeft, text, w, width, word, wordWidths, words, wrap, _i, _j, _len, _len1, _ref;
      wrap = this._wrapState;
